namespace DurableTask.SqlServer
{
    ...
    class TraceHelper
    {
        ...
        static class Events
        {
            public static readonly EventId SprocCompleted = new EventId(300, nameof(SprocCompleted));
            public static readonly EventId SprocFailed = new EventId(301, nameof(SprocFailed));
